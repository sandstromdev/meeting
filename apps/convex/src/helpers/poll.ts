import type { MajorityRule } from '@lsnd-mt/common/polls';
import { getEligibleVotes, minimumVotesForMajority } from '@lsnd-mt/common/polls';
import { normalizeStoredPollOptions, type StoredPollOptions } from '@lsnd-mt/common/pollOptions';
import type { PollOptionTotal } from '@lsnd-mt/common/pollOptionTotal';
